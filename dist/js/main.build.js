...
},{"./views/app/app":8,"jquery":26}],2:[function(require,module,exports){
'use strict';
...
},{"backbone":16,"bowser":17}],3:[function(require,module,exports){
'use strict';
...
},{"../vendor/gsap/TweenMax":5}],4:[function(require,module,exports){
'use strict';
...
},{"../views/about/about.js":7,"../views/contact/contact.js":10,"../views/header-nav/nav.js":12,"../views/home/home.js":13,"../views/update/update.js":15,"backbone":16,"jquery":26}],5:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.18.0
 * DATE: 2015-09-05
...
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"l-section-container\">\n	\n	<h1 class='text-center'>About View</h1>\n	<img src=\"<%= data.images[0] %>\" alt=\"placekitten\">\n	<h2>Oh yeah</h2>\n	<h1><%= data.title %></h1>\n	<p><%= data.body %></p>\n	<p><%= data.body %></p>\n</div>\n";
},"useData":true});
...
},{"../../modules/AnimationController":3,"./about.html":6,"backbone":16,"jquery":26,"underscore":27}],8:[function(require,module,exports){
'use strict';
...
},{"../../models/appModel":2,"../../routers/appRouter":4,"backbone":16,"jquery":26,"underscore":27}],9:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"l-section-container\">\n  \n  <h1 class='text-center'>Contact View</h1>\n  <h2>Oh yeah</h2>\n  <img src=\"<%= data.images[0] %>\" alt=\"placekitten\">\n  <h1><%= data.title %></h1>\n  <p><%= data.body %></p>\n  <p><%= data.body %></p>\n\n</div>\n  \n";
},"useData":true});
...
},{"../../modules/AnimationController":3,"./contact.html":9,"backbone":16,"jquery":26,"underscore":27}],11:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<button class=\"btn-mobile-nav\">menu</button>\n\n<div class=\"l-site-nav\">\n  <nav>\n  	<ul>\n  	  <li><a href=\"#home\">HOME</a></li>\n  	  <li><a href=\"#about\">ABOUT</a></li>\n  	  <li><a href=\"#contact\">CONTACT</a></li>\n  	  <li><a href=\"#update\">UPDATE</a></li>\n  	</ul>\n  </nav>\n</div>\n";
},"useData":true});
},{"handlebars/runtime":25}],12:[function(require,module,exports){
'use strict';
...
},{"./nav.html":11,"backbone":16,"jquery":26,"underscore":27}],13:[function(require,module,exports){
'use strict';
...
},{"../../modules/AnimationController":3,"backbone":16,"jquery":26,"underscore":27}],14:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"l-section-container\">\n  \n  <h1 class='text-center'>Update View</h1>\n  <h2>Oh yeah</h2>\n  <img src=\"<%= data.images[0] %>\" alt=\"placekitten\">\n  <h1><%= data.title %></h1>\n  <p><%= data.body %></p>\n  <p><%= data.body %></p>\n\n</div>\n  \n";
},"useData":true});
},{"handlebars/runtime":25}],15:[function(require,module,exports){
'use strict';
...
},{"../../modules/AnimationController":3,"./update.html":14,"backbone":16,"jquery":26,"underscore":27}],16:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
...
},{"jquery":26,"underscore":27}],17:[function(require,module,exports){
/*!
